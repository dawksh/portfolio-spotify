...
export default function Container({ children, ...customMeta }: ContainerProps) {
  ...
  const meta = {
    title: "Daksh Kulshrestha",
    description: `web3 developer and NFT enthusiast`,
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:site_name" content="Daksh Kulshrestha" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta property="og:image:alt" content={meta.title} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@0xDaksh" />
